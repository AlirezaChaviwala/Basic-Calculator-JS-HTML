...
var att = ["type", "placeholder", "value", "name", "disabled"];
var val = ["text", "0", "0", "displayResult", "true"];
...
pow.onclick = function() {
    if (form.num5.disabled == 'false') {
        form.num5.disabled = 'true';
    } else {
        form.num5.disabled = 'false';
    }
}

var clear = document.createElement('input');
var attc = ["type", "value", "name", "disabled"];
var valc = ["button", "CLE", "clear", "true"];
...
var attcent = ["type", "value", "name", "onclick", "disabled"];
var valcent = ["button", "%", "cent", "tap(cent.value)", "true"];
for (var i = 0; i < attcent.length; i++) {
    cent.setAttribute(attcent[i], valcent[i])
}

var del = document.createElement('input');
var attd = ["type", "value", "name", "disabled"];
var vald = ["button", "DEL", "delete", "true"];
...
var att7 = ["type", "name", "value", "class", "onclick", 'disabled'];
var val7 = ["button", "num7", "7", "order-first", "tap(num7.value)", "true"];
for (var i = 0; i < att7.length; i++) {
    num7.setAttribute(att7[i], val7[i])
}

var num8 = document.createElement('input');
var att8 = ["type", "name", "value", "onclick", "disabled"];
var val8 = ["button", "num8", "8", "tap(num8.value)", "true"];
for (var i = 0; i < att8.length; i++) {
    num8.setAttribute(att8[i], val8[i])
}

var num9 = document.createElement('input');
var att9 = ["type", "name", "value", "onclick", "disabled"];
var val9 = ["button", "num9", "9", "tap(num9.value)", "true"];
for (var i = 0; i < att9.length; i++) {
    num9.setAttribute(att9[i], val9[i])
}

var addb = document.createElement('input');
var attadd = ["type", "name", "value", "onclick", "disabled"];
var valadd = ["button", "addb", "+", "tap(addb.value)", "true"];
...
var att4 = ["type", "name", "value", "class", "onclick", "disabled"];
var val4 = ["button", "num4", "4", "order-first", "tap(num4.value)", "true"];
...
var att6 = ["type", "name", "value", "onclick", "disabled"];
var val6 = ["button", "num6", "6", "tap(num6.value)", "true"];
for (var i = 0; i < att6.length; i++) {
    num6.setAttribute(att6[i], val6[i])
}

var subb = document.createElement('input');
var attsub = ["type", "name", "value", "onclick", "disabled"];
var valsub = ["button", "subb", "-", "tap(subb.value)", "true"];
...
var att1 = ["type", "name", "value", "class", "onclick", "disabled"];
var val1 = ["button", "num1", "1", "order-first", "tap(num1.value)", "true"];
for (var i = 0; i < att1.length; i++) {
    num1.setAttribute(att1[i], val1[i])
}

var num2 = document.createElement('input');
var att2 = ["type", "name", "value", "onclick", "disabled"];
var val2 = ["button", "num2", "2", "tap(num2.value)", "true"];
for (var i = 0; i < att2.length; i++) {
    num2.setAttribute(att2[i], val2[i])
}

var num3 = document.createElement('input');
var att3 = ["type", "name", "value", "onclick", "disabled"];
var val3 = ["button", "num3", "3", "tap(num3.value)", "true"];
for (var i = 0; i < att3.length; i++) {
    num3.setAttribute(att3[i], val3[i])
}

var mulb = document.createElement('input');
var attmul = ["type", "name", "value", "onclick", "disabled"];
var valmul = ["button", "mulb", "*", "tap(mulb.value)", "true"];
...
var att0 = ["type", "name", "value", "class", "onclick", "disabled"];
var val0 = ["button", "num0", "0", "order-first", "tap(num0.value)", "true"];
for (var i = 0; i < att0.length; i++) {
    num0.setAttribute(att0[i], val0[i])
}

var dotb = document.createElement('input');
var attdot = ["type", "name", "value", "onclick", "disabled"];
var valdot = ["button", "dotb", ".", "tap(dotb.value)", "true"];
for (var i = 0; i < attdot.length; i++) {
    dotb.setAttribute(attdot[i], valdot[i])
}

var divb = document.createElement('input');
var attdiv = ["type", "name", "value", "onclick", "disabled"];
var valdiv = ["button", "divb", "/", "tap(divb.value)", "true"];
for (var i = 0; i < attdiv.length; i++) {
    divb.setAttribute(attdiv[i], valdiv[i])
}

var res = document.createElement('input');
var attres = ["type", "name", "value", "class", "onclick", "disabled"];
var valres = ["button", "res", "=", "res", "result()", "true"];
